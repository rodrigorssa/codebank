...
type TransactionRepository interface {
	SaveTransaction(transaction domain.Transaction, creditCard domain.CreditCard) error
	GetCreditCard(creditCard domain.CreditCard) (domain.CreditCard, error)
	CreateCreditCard(creditCard domain.CreditCard) error
}
...
func (t *TransactionRepositoryDb) GetCreditCard(creditCard domain.CreditCard) (domain.CreditCard, error) {
	...
	if err != nil {
		return c, errors.New(enums.TransactionErrors.NOT_FOUND)
	}
	return c, nil
}
